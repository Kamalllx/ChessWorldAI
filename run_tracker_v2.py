...
class SmartTrackerV2:
    ...
    def __init__(self, model_path: Optional[str] = None, device: str = 'auto'):
        ...
        self.vote_window = 4  # REDUCED from 8 for faster response
        ...
        self.cooldown = 10  # REDUCED from 20 for faster response
    ...
    def _analyze(self) -> Optional[str]:
        ...
        # Get most voted piece type per square (need >30% votes)
    ...
    def _find_best_move(self, vacated: Set[int], appeared: Set[int], 
        ...
        return best_move if best_score >= 5 else None
