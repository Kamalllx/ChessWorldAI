import { findPiecesHybrid } from "../../utils/findPiecesHybrid";
...
const Video = ({ piecesModelRef, canvasRef, videoRef, sidebarRef, playing, 
  ...
  useEffect(() => {
    ...
    findPiecesHybrid(piecesModelRef, videoRef, canvasRef, playingRef, setText, dispatch, 
      cornersRef, boardRef, movesPairsRef, lastMoveRef, moveTextRef, mode, settings.usePositionTracking);
